...
<div class="sms-suite-contact-groups">
    ...
    <div class="panel panel-default">
        <div class="panel-heading">
            <h3 class="panel-title">Your Contact Groups</h3>
        </div>
                ...
                <table class="table table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <span class="badge">{$group->contact_count}</span>
                                {if $group->contact_count > 0}
                                <a href="{$modulelink}&action=contacts&group_id={$group->id}" class="btn btn-xs btn-link">View</a>
                                {/if}
                            </td>
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <form method="post">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-default" data-dismiss="modal">Cancel</button>
                    <button type="submit" class="btn btn-danger" id="delete_btn">Delete Group</button>
                </div>
            </form>
        </div>
    </div>
